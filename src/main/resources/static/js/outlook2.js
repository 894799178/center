...
function InitLeftMenu() {
	...
	$('.easyui-accordion li a').click(function(){
		...
		let menuid = $(this).attr("ref");
		let icon = getIcon(menuid,icon);
	...
	let t = panels[0].panel('options').title;
...
{
	let s = '<iframe scrolling="auto" frameborder="0"  src="'+url+'" style="width:100%;height:100%; "></iframe>';
	return s;
}
...
function tabCloseEven()
{
	...
	$('#mm-tabclose').click(function(){
		let currtab_title = $('#mm').data("currtab");
